...
void addFirst(char nama[], char kelamin[], char asal[], list *L)
{
    ...
    strcpy(baru->kontainer.kelamin, kelamin);
...
void addLast(char nama[], char kelamin[], char asal[], list *L)
{
    ...
    else
    {
        ...
        addAfter(prev, nama, kelamin, asal, L);
    }
}
...
void printElemen(list L)
{
    if (L.first != NULL)
    {
        ...
        while (tunjuk != NULL)
        {
            ...
            printf("%s - ", tunjuk->kontainer.kelamin);
            printf("%s\n", tunjuk->kontainer.asal);
